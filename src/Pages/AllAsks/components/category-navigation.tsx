...
export function CategoryNavigation({ onCategoryChange }: CategoryNavigationProps) {
  const [activeServiceType, setActiveServiceType] = useState<string>("engineer") // Default to engineer
